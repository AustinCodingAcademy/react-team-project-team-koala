                ...
                <>
                  <tr key={dat.id}>
                    ...
                    {this.state.fields.length >= 0 && (
                      <td name={this.state.fields[0]}>{dat[this.state.fields[0]]}</td>
                    )}
                    {this.state.fields.length > 1 && (
                      <td name={this.state.fields[1]}>{dat[this.state.fields[1]]}</td>
                    )}
                    {this.state.fields.length > 2 && (
                      <td name={this.state.fields[2]}>{dat[this.state.fields[2]]}</td>
                    )}
                    {this.state.fields.length > 3 && (
                      <td name={this.state.fields[3]}>{dat[this.state.fields[3]]}</td>
                    )}
                    {this.state.fields.length > 4 && (
                      <td name={this.state.fields[4]}>{dat[this.state.fields[4]]}</td>
                    )}
                    {this.state.fields.length > 5 && (
                      <td name={this.state.fields[5]}>{dat[this.state.fields[5]]}</td>
                    )}
                    {this.state.fields.length > 6 && (
                      <td name={this.state.fields[6]}>{dat[this.state.fields[6]]}</td>
                    )}
